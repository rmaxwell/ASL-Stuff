		 ...
		 <div class="slider-wrapper theme-default">
			...
			<div id="columncontent">
				<div class="column" id="col1">
					<h2>STUFF Tweets!</h2>
					<div class="tweet"></div>	
 					<h3><a href="https://twitter.com/STUFF_mascot" class="twitter-follow-button" data-show-count="false">Follow @STUFF_mascot</a></h3>
				</div>
				<div class="column" id="col2">
					...
					<table id="progressList">
					  <tr>
					    ...
					    <td class="progressTask"><a href="#">Awesome Dunk</a></td>
