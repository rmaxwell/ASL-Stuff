                ...
                init: function (x) {
                    ...
                    if (x.version >= 2 && !TWTR.Widget.hasLoadedStyleSheet) {
                        if (x.creator) {
                            ...
                            s.loadStyleSheet(t + "/css/widget.css", this.widgetEl)
                        }
                    }
...
Made with a great help of Jason Diamond, Patrick Hof, Nochum Sossonko, Andreas Schneider, Dave Vasilevsky, Vital Batmanov, Ron Baldwin, Gabriel Harrison, Chris J. Shull, Mathias Bynens, Vittorio Gambaletta and others.
